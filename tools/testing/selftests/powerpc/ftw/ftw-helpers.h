 ...
 */
#ifndef FTW_HELPERS_H
#define FTW_HELPERS_H
#include <stdio.h>
#include <errno.h>
#include <unistd.h>
#include <stdint.h>
...
static inline void do_wait(void)
{
...
extern void *alloc_init_crb(void);
extern int write_crb(void *crb, void *paste_addr, char *msg);
